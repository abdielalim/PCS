package com.abdielalim.localpride.ui.base
...
import com.abdielalim.localpride.BR
...
abstract class BaseAdapter<T>(@field:LayoutRes private var layoutId: Int) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun onBin(variable: Int?, data: Any?): ViewDataBinding? {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        listData?.let {
            ...
            val binding = holder.onBin(BR.model, data)
            onBind(binding, data)
